 ...
 */
export const Resources: React.FC<{ resources: Resource[] }> = ({
  resources,
}) => {
  return (
    <div m="b-32 lg:b-0" grid="~ lg:cols-4" text="center lg:left">
      {resources.map(({ title, href, description }) => (
        ...
        >
          <h2 m="b-3" text="2xl" font="moneItalic">
            {title}
            <span
          ...
          <p m="0" max-w="[30ch]" text="sm" className="opacity-50">
            {description}
          </p>
        </a>
      ))}
